...
{
cout << endl;
cout << "Recursive Linear Search of Vector for target value " << 
targets[i] << ":\t";
...
cout << "Not found :-(" << endl;
cout << endl;
cout << "Recursive Linear Search of List for target value " << 
targets[i] << ":\t";
if (rec_linear_search_L(mylst.begin(), mylst, targets[i]) != 
mylst.end())
cout << "Found :-)" << endl;
else
cout << "Not found :-(" << endl;
...
{
cout << endl;
cout << "Iterative Binary Search of Vector for target value " << 
targets[i] << ":\t";
...
cout << "Not found :-(" << endl;
cout << endl;
cout << "Recursive Binary Search of List for target value " << 
targets[i] << ":\t";
